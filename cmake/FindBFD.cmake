...
if(USE_3P_LIBS AND 3P_BFD_FOUND)
    ...
    set(BFD_FOUND TRUE)
    set(HAVE_BFD_H TRUE)
    # 3p BFD requires PACKAGE/PACKAGE_VERSION to be defined before including bfd.h
    set(BFD_NEEDS_PACKAGE_DEFS TRUE)
    # 3p BFD uses 1-arg API for section functions (modern API)
    set(BFD_HAS_1_ARG_API TRUE)
else()
